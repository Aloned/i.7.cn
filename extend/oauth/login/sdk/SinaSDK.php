...
// +----------------------------------------------------------------------
// | SinaSDK.php  By Taoge 2017/9/28 11:34
// +----------------------------------------------------------------------
namespace oauth\login\sdk;

use oauth\login\OauthLogin;

class SinaSDK extends OauthLogin
{
    ...
    public function openid()
    {
        ...
        if (isset($data['openid']))
            ...
            throw new \think\Exception('没有获取到新浪微博用户ID！');
    }
