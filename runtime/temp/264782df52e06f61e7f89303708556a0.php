<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/private/var/www/committee/application/admin/view/photo/addphoto.html";i:1530583463;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<div class="my-content">
					<form method="post" class="layui-form" action="">
						<table class="layui-table">
							...
							<tr>
								<td align="right">预留字段：</td>
								<td>
									<div class="layui-form-item">
										<div class="layui-input-inline my-input-line">
											<input type="text" name="reserved" class="layui-input" placeholder="预留字段" />
										</div>
										<div class="layui-form-mid layui-word-aux"><span class="txt-color4">预留字段：请合理使用，如：职务</span></div>
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<div class="layui-form-item">
										<div class="layui-input-inline my-input-line">
											<button class="layui-btn" lay-submit="" data-url="<?php echo url('photo/addphoto'); ?>" lay-filter="addphoto">保存</button>
	...
	<script type="text/javascript">
		layui.use(['element','form'],function(){
			...
			var url = '/category/getCategory/parent_id/'+ <?php echo $type; ?>;
